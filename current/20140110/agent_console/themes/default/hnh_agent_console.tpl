		...
		<table cellspacing="5" style="font-size: 13px">
			<tbody>
                <tr>
					...
					<td>					
						<input type="text" style="height:20px;width:243px;float:left;" class="ticket-form" id="customer_name" name="customer_name" value="{$CUSTOMER_INFO.lastname} {$CUSTOMER_INFO.firstname}">
                ...
                <tr>
                    <td>Số điện thoại</td>
                    <td>
                        <input type="text" style="height:20px;width:243px;float:left;" class="ticket-form" id="customer_number" name="customer_number" value="{$CUSTOMER_NUMBER}" readonly/>
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="ticket-form" id="description" name="description" style="width:312px;height:150px;"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
...
<div id="box">
	<dl>	   
		<dt id="paylink">
            ...
            <a class="ic-minimize" href="javascript:void(0)" onclick="view_customer('{$CUSTOMER_INFO.id}')"><img src='{$THEME_PATH}/images/extra.png' title='Xem chi tiết'></a>
		</dt>
		<dd class="plink">
    ...
    <table cellspacing="5" style="font-size: 13px">
        <tbody>
            <tr>
                ...
                <td width="25%">
                    <input type="text"  class="ticket-form" id="deliver-name" name="deliver-name" value="{$CUSTOMER_INFO.lastname} {$CUSTOMER_INFO.firstname}"/>
                </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="ticket-form" id="deliver-code" name="deliver-code" style="width:130px;height:60px;"></textarea>
            </td>
        </tr>
        <tr>
            <td>Địa chỉ <span style="color:red">*</span></td>
            <td colspan="3">
                <textarea class="ticket-form" id="deliver-address" name="deliver-address" style="width:258px;height:45px;">{$CUSTOMER_INFO.address}</textarea>
            </td>
        </tr>
		<tr>
            <td>Ghi chú <span style="color:red">*</span></td>
            <td colspan="3">
                <textarea class="ticket-form" id="deliver-note" name="deliver-note" style="width:258px;height:30px;"></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<div id="customer_detail" title="THÔNG TIN KHÁCH HÀNG" style="display: none;">
    ...
    <tbody>
        ...
        <tr>
            <td>Họ và tên đệm</td>
            <td>
                <input id="customer_detail_1-lastname" type="text"  class="ticket-form"/>
            </td>
            <td>Ngày sinh</td>
            <td>
...
<div id="dialog" title="LƯU THÔNG TIN KHÁCH HÀNG"  stype="dislay:none">
    ...
    <tr>
        ...
        <td><input type="text" id="customer_firstname" style="width:150px;" value="{$CUSTOMER_INFO.firstname}"></td>
        <td><label for="customer_lastname">Họ và tên đệm: </label></td>
        <td><input type="text" id="customer_lastname" style="width:150px;" value="{$CUSTOMER_INFO.lastname}"></td>
    </tr>
    <tr>
...
<div id="view_customer_dialog" title="Xem chi tiết thông tin khách hàng" stype="dislay:none">
    ...
    <div id="KHLE">
        ...
        <div class="row">
            ...
            <span> 	&nbsp;</span>
            <label >Công ty: </label>
            <input type="text" id="view_customer_company" readonly>
        </div>
        <div class="row">
...
$(document).ready(function(){
	...
	$('#btn-add-customer').click(function() {
        ...
        $('#customer_firstname').val("{/literal}{$CUSTOMER_INFO.firstname}{literal}");
        $('#customer_lastname').val("{/literal}{$CUSTOMER_INFO.lastname}{literal}");
    ...
    $('#btn_guardar_formularios').click(function(){
        ...
        if (($('#btn-add-customer').val() == 'Thêm mới') && $('#customer_name').val().trim() != '(không biết)') {
            $.post('index.php?menu=' + module_name + '&rawmode=yes', {
                    action:		'addCustomer',
    ...
    $('#btn_deliver').click(function(){
        ...
        if (ticket_id.trim()==''){
            ...
            alert('Chức năng này đang cập nhật. Vui lòng thử lại sau!');
        }
    });
});
</script>
