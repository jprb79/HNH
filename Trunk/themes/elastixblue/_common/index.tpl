    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" {$BODYPARAMS}>
        {$MENU} <!-- Viene del tpl menu.tlp-->
			...
			<tr class="moduleTitle">
			  <td width="35%" class="moduleTitle" valign="middle" colspan='2'>&nbsp;&nbsp;{if $icon ne null}<img src="{$icon}" border="0" align="absmiddle">&nbsp;&nbsp;{/if}{$title}
                  &nbsp;&nbsp;
              </td>
			</tr>
                        <tr>
                    ...
                    <div align="center" class="copyright">Hệ thống tổng đài dành cho đại lý bán vé Hồng Ngọc Hà </br> Cung cấp bởi <a href="http://cloudteam.vn" target='_blank'>Công ty CP Nhóm Mây</a> - {$currentyear}.</div>
                    <br>
                </td>
            </tr>
        </table>
