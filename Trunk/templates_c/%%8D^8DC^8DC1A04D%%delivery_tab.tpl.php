<?php /* Smarty version 2.6.14, created on 2014-03-18 00:07:16
         compiled from /var/www/html/modules/agent_console/themes/default/delivery_tab.tpl */ ?>
<?php echo '
    <style type="text/css">
...
<script type="text/javascript">
    $("#delivery_tab").flexigrid({
        ...
        colModel : [
            ...
            {display: \'<b>Ngày xuất vé</b>\', name : \'purchase_date\', width : 115, sortable : true, align: \'right\'},
    ...
    function edit_delivery(ticket_id)
    {
        ...
        $.post(\'index.php?menu=\' + module_name + \'&rawmode=yes\', {
            ...
            function (response) {
                ...
                $("#deliver-purchasedate").val(response[\'message\'][\'purchase_date\']);
                $("#deliver-note").val(\'\');
