    ...
    $('.left_side').resizable({
        ...
        stop: function(event, ui) {
            ...
            var arrAction              = new Array();
                ...
                request("index.php?menu=pbx_operator",arrAction,false,
...
function actualizar()
{
	...
	var arrAction              = new Array();
	    ...
	    arrAction["rawmode"]   = "yes";
	    request("index.php?menu=pbx_operator",arrAction,true,
		function(arrData,statusResponse,error)
		{
...
function eventStateCall(exten, state_call){
    ...
    if(img){
        if(state_call=="Ringing"){
                img.setAttribute("src","modules/pbx_operator/images/phoneRinging.gif");
        }if(state_call=="Up"){
                img.setAttribute("src","modules/pbx_operator/images/icon_upPhone.png");
        }if(state_call=="Down"){
                ...
                span1.firstChild.nodeValue = "";
                span2.firstChild.nodeValue = "";
                img.setAttribute("src","modules/pbx_operator/images/phhonez0.png");
        }
    }
}
...
function eventVoicemail(exten, voicemail){ 
    ...
    if(tmp[0]=="1"){
        div.innerHTML = "<a class='Ntooltip' href='#'><img id='mail_"+exten+"' class='mail_box' src='modules/pbx_operator/images/mail.png'/><span>"+tmp[1]+"&nbsp;</span></a>";
    }else{
        div.innerHTML = "";
    }
}
...
function reloadDevices(arrRefresh){
     for(key in arrRefresh){
        ...
        if(voicemail=="1"){
            ...
            img[0].setAttribute("src","modules/pbx_operator/images/mail.png");
        }else{
            subdiv[2].innerHTML = "";
        }
        ...
        if(state_call=="Ringing"){
            img[0].setAttribute("src","modules/pbx_operator/images/phoneRinging.gif");
        }if(state_call=="Up"){
            img[0].setAttribute("src","modules/pbx_operator/images/icon_upPhone.png");
        }if(state_call=="Down"){
            img[0].setAttribute("src","modules/pbx_operator/images/phhonez0.png");
        }
