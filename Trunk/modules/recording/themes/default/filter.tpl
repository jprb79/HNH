{literal}
<link href="modules/recording/themes/default/skin/blue.monday/jplayer.blue.monday.css" rel="stylesheet" type="text/css" />
<style type="text/css">
/* DIALOG */
...
<!-- dialog listen recording -->
<div id="player_dialog" title="Nghe ghi âm"></div>
<!-- end of dialog listen recording -->