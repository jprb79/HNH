...
function updateRate(&$pDB,$pACL)
{
    ...
    // collect parameters
    $data = array(
        'sabre' => trim(getParameter('sabre')),
        'bsp' => trim(getParameter('bsp')),
        'lion_air' => trim(getParameter('lion_air')),
        'air_asia' => trim(getParameter('air_asia')),
        'lao_airlines' => trim(getParameter('lao_airlines')),
        'transviet' => trim(getParameter('transviet')),
        'note'      => trim(getParameter('note')),
        'elastix_user_id'   =>  $idUser
    );
