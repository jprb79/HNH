...
class getInfoMainConsole{
    ...
    public function getCustomerInfo($mobile)
    {
        try{
            ...
            $arr_contact = $this->runSQL("SELECT * FROM customer_contact WHERE phone = '$mobile' and customer_id = $id");
        ...
        try{
            ...
            if (!$edit) {
                ...
                $sql = "UPDATE ticket_delivery SET
                    ...
                    customer_name = '$customer_name', customer_phone = '$customer_phone', isInvoice = $isInvoice
                    WHERE id=$id";
                $result = mysql_query($sql);
                if (!$result){
                    //$this->errMsg = $sql;
        ...
        try{
            ...
            if ($customer_id != '') {
                $sql= "UPDATE customer SET
						  ...
						  email='$params[9]',
						  agent_id=$params[10],
						  latest_note = 'Updated by $agent on $date'
