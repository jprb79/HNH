            ...
            if (!strpos($result[$index]['userfield'],$result[$index]['uniqueid'])) {
                switch ($result[$index]['dcontext']){
                    ...
                    case 'from-did-direct':
                        ...
                        break;
                    case 'from-internal':
                        $result[$index]['userfield'] = "audio:".date('Ymd-His',strtotime($result[$index]['calldate'])).'-'.$result[$index]['uniqueid'].'.gsm';
                        break;
                    case 'ext-queues':
                        $result[$index]['userfield'] = "audio:/var/spool/asterisk/monitor/q".$result[$index]['dst']."-".date('Ymd-His',strtotime($result[$index]['calldate'])).'-'.$result[$index]['uniqueid'].'.gsm';
                        break;
                    default:
                        break;
                }
            }
            // handle in case userfield is blank
